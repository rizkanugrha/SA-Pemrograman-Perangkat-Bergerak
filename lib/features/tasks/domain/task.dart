...
///
/// Field diseragamkan antar starter P01–P05. Pada P05, serialisasi JSON
/// eksplisit via [toJson]/[fromJson] mengikuti kontrak di
/// `06-Starter-Code/API-CONTRACT.md`.
class Task {
  final String id;
  final String title;
  ...
  /// Membaca dari JSON (response API). Lihat `API-CONTRACT.md`.
  ...
  /// Menulis ke JSON (body request). Field cocok kontrak API.
